...
- [`Mesh/status.md`](./Mesh/status.md) for implementation status.
- [`Mesh/scoring.md`](./Mesh/scoring.md) for the production scoring contract.
- [`Mesh/testing.md`](./Mesh/testing.md) for the regression suite taxonomy.
